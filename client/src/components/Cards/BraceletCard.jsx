            ...
            {props.data && (
                <div style={{
                    ...
                    >
                        ...
                        <div style={{display:'grid', gridTemplateColumns: `150px 1fr`, rowGap:20, columnGap:20, alignItems:'start'}}>
                            ...
                            <div style = {{
                                ...
                                {props.data.engraving && props.data.engravingcontent &&
                                    <div style={{display:'flex', flexDirection:'row', gap:'10%', alignItems: 'center'}}><strong>Content</strong><p>{props.data.engravingcontent}</p></div>}
                            <div></div>
                        ...
                        >
                        <button
                            onClick={() => deleteBracelet(props.data.id)}
                            style={{
                            background: '#FF0000',
                            color: 'white',
                            fontWeight: 'bold',
